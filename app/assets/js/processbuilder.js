...
class ProcessBuilder {
    ...
    build(){
        ...
        if(!mcVersionAtLeast('1.16.10F', this.server.rawServer.minecraftVersion)){
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=SalamoonLauncher')
                ...
                if(argDiscovery.test(args[i])){
                    ...
                    switch(identifier){
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'Salamoon-Launcher')
                            break
